...
CSRC = $(STARTUPSRC) \
       ...
       main.c plot.c ui.c ili9341.c sd_card.c tlv320aic3204.c si5351.c numfont20x22.c Font5x7.c Font10x14.c flash.c si4468.c  Font7x13b.c rtc.c
else
CSRC = $(STARTUPSRC) \
       $(KERNSRC) \
       $(PORTSRC) \
...
ifeq ($(TARGET),F303)
 UDEFS = -DARM_MATH_CM4 -DVERSION=\"$(VERSION)\" -DSHORT_VERSION=\"$(SHORT_VERSION)\" -DPROJECT_STR=\"$(PROJECT)\" -DTINYSA_F303 -D__FPU_USED -DST7796S -DTINYSA4
